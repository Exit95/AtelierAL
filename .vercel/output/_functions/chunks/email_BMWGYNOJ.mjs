...
async function sendBookingConfirmation(to, workshopTitle, name, participants, date) {
  const mailOptions = {
...
async function sendAdminNotification(workshopTitle, name, email, phone, participants, message) {
  const mailOptions = {
...
async function sendContactNotification(name, email, phone, preferredDate, message) {
  const mailOptions = {
...
export { sendAdminNotification, sendBookingConfirmation, sendContactNotification };
